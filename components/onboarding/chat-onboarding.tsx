              ...
              <div className="max-w-[90%] w-full rounded-xl border border-zinc-200 bg-white p-4 shadow-sm space-y-3">
                ...
                <div className="space-y-2">
                  <input
                    ...
                    className="w-full rounded-lg border border-zinc-200 bg-white px-3 py-2 text-sm text-zinc-800 placeholder:text-zinc-400 outline-none focus:border-primary focus:ring-2 focus:ring-primary/20"
                  />
